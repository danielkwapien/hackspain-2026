...
- [`INFORME-EMBAT.md`](INFORME-EMBAT.md) — investigación sobre Embat, sector, regulación, competencia, arquitectura y API, del 18/09/2026. Con marcas de procedencia y enlaces.
- [`embat-openapi.json`](embat-openapi.json) — spec OpenAPI 3.1 de la API pública de Embat v2.120.53, descargada el 18/09/2026.
