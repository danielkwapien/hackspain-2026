...
| 1 | XR-001 | Dataset mock completo del motor (`datasets_mocked/`) + API v2 que lo sirve | amplio | XR-000 | building | sesión XR-001 | 0 | xr/XR-001-mock-dataset · [PR #2 (draft)](https://github.com/danielkwapien/hackspain-2026/pull/2) | plans/XR-001-mock-dataset/PLAN.md |
