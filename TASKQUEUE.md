...
| 2 | XR-002 | Sistema de tokens Embat × Trade Republic, tipografía, semántica de datos, playground `/tokens` | contenido | XR-000 | todo | | 0 | xr/XR-002-design-tokens | plans/XR-002-design-tokens/PLAN.md |
| 3 | XR-003 | Shell de tablero: topbar con espacios, rejilla 24 col de widgets (drag/resize/dup), marco con selector de entidad y vínculo, widget Buscador y Score simple | amplio | XR-001, XR-002 | todo | | 0 | xr/XR-003-widget-shell | plans/XR-003-widget-shell/PLAN.md |
