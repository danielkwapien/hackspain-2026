...
| 2 | XR-002 | Sistema de tokens Embat × Trade Republic, tipografía, semántica de datos, playground `/tokens` | contenido | XR-000 | review | sesión XR-002 | 0 | xr/XR-002-design-tokens `562f2af` · [PR #1](https://github.com/danielkwapien/hackspain-2026/pull/1) (evidencia en plans/XR-002-design-tokens/evidence/) | plans/XR-002-design-tokens/PLAN.md |
