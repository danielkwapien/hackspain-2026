...
| 12 | XR-012 | Sistema de gráficas compartido: primitivas (línea sin ejes, sparkline, barra de rango, área de banda, treemap), tooltips, colores por régimen | amplio | XR-002 | building | sesión XR-012 | 0 | xr/XR-012-chart-primitives (spec+check en rojo) | plans/XR-012-chart-primitives/PLAN.md |
