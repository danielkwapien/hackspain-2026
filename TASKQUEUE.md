...
| 2 | XR-002 | Sistema de tokens Embat × Trade Republic, tipografía, semántica de datos, playground `/tokens` | contenido | XR-000 | building | sesión XR-002 | 0 | xr/XR-002-design-tokens | plans/XR-002-design-tokens/PLAN.md |
