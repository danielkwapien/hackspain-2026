...
Las señales reciben ese panel común y devuelven un valor por fila. `active.py` decide cuáles participan;
`scoring_embat.py` las normaliza, combina y calcula la trayectoria. Finalmente se genera un único JSON con
los 250 grupos y su serie de 24 meses. Septiembre de 2026 se excluye porque solo contiene un día de datos.
