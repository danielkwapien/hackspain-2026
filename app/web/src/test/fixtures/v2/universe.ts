...
type GroupUniverseItem = Omit<{ [K in keyof ApiGroupItem]: K extends "outlook_label" | "group_name" ? ApiGroupItem[K] : NonNullable<ApiGroupItem[K]> }, "group_id"> & { group_id: null };
