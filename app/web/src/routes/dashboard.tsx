 ...
 *
 * A partir de 1280 px (`xl:`) dos columnas `10fr 14fr`: Empresas a la izquierda a
 * toda altura, y a la derecha Comparativa (≈ 40 % del alto) sobre Investigación.
...
export function DashboardPage(): ReactElement {
  return (
    <div
      className="grid h-full grid-cols-1 auto-rows-[minmax(360px,auto)] p-4 xl:grid-cols-[10fr_14fr] xl:grid-rows-[minmax(280px,2fr)_3fr]"
