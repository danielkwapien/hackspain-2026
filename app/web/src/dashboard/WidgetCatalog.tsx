        ...
        return (
          ...
          >
            ...
            <span className="flex min-w-0 flex-col">
              ...
              <span className="line-clamp-2 text-[length:var(--text-micro)] text-content-secondary">
